...
public class Level2State extends State {
    ...
    public Level2State(int skorFromLvl1){
        ...
        yellowtime= (int) (Math.random()*2)+4;
        yellowctrl = false;
    ...
    public void render() {
        ...
        if(time<=30) {
            ...
            if (red1xctrl == true) {
                red1x += (int) (redspeed * Gdx.graphics.getDeltaTime());
            } else {
                red1x -= (int) (redspeed * Gdx.graphics.getDeltaTime());
            }
            //red1 y control
            ...
            if (red1yctrl == true) {
                red1y += (int) (redspeed * Gdx.graphics.getDeltaTime());
            } else {
                red1y -= (int) (redspeed * Gdx.graphics.getDeltaTime());
            }
            ...
            if(skor>=100 && redpatladimi==true && greenpatladimi==true && yellowpatladimi==true){
                ...
                BalonPatlatma.sm.pushState(new Level3State(highSkor));
            }
            else if(time<=35){
